...
public class FormSistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblProx.setForeground(new java.awt.Color(153, 153, 255));
        ...
        tabelaDados.setGridColor(new java.awt.Color(153, 255, 0));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javasort/Gif 2 Luffy.gif"))); // NOI18N
        jLabel2.setText("jLabel2");
        jLabel2.setToolTipText("");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javasort/Gif Luffy.gif"))); // NOI18N
    ...
    private void btnBuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscaActionPerformed
       int cont=0;
        ...
        case 0:  if(opSeq.isSelected()){
                  ...
                  if(pos<0)
                  {
                     JOptionPane.showMessageDialog(null,"Capítulo Inexistente"); 
                  }
                  else
                  {
